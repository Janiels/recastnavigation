...
public:
	...
	/// In order for A* searches to work properly, the cost returned should be proportional to
	/// the travel distance. In addition, the cost returned should always be longer than the straight path
